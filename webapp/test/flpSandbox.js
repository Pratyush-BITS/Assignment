			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"DataUpdater-display": {
								"semanticObject": "DataUpdater",
								"action": "display",
								"description": "Learing how to update model from from user&#x27;s input.",
								"title": "Data Updater",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.learn.assignment",
									"url": sap.ui.require.toUrl("com/learn/assignment")
								}
							}
						}
					}
